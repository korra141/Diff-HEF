...
def main(args):
    ...
    train_loader =  generating_data_S1_unimodal_beta(data_path,args.batch_size, args.n_samples, args.trajectory_length, args.alpha, args.beta, args.step_size, True)
    val_loader =  generating_data_S1_unimodal_beta(data_path,args.batch_size, args.batch_size, args.trajectory_length, args.alpha, args.beta, args.step_size, True)
