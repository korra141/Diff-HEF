...
def parse_args():
    ...
    parser.add_argument("--log-dir", type=str, default="./logs/exp1/", help="Directory to save the logs")    
...
def main(args):
    ...
    train_loader =  generating_data_S1(args.batch_size, args.n_samples, args.trajectory_length, args.measurement_noise, args.step_size, True)
    test_loader = generating_data_S1(args.batch_size, 20, args.trajectory_length, args.measurement_noise, args.step_size, False)
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (ground_truth, measurements) in enumerate(train_loader):
            ...
            if i % 50 == 0 and epoch % args.log_freq == 0:
                ...
                ax = plotting_von_mises(ground_truth[0],args.measurement_noise**2, args.band_limit,ax,"true distribution")
