...
from src.models.CNN import DensityPredictorCNN,init_weights_identity,init_weights_zero,init_weights,CNNModel_A
  ...
  for epoch in range(num_epochs):
    ...
    for batch_idx, (ground_truth, measurements) in enumerate(train_loader):
      ...
      if batch_idx==0 and epoch % 10 == 0:
        ...
        # else:
        #   plot_3d(ground_truth[sample_idx],measurements[sample_idx],range_x,range_y,band_limit,true_density[sample_idx],predicted_density[sample_idx],input_pose_density[sample_idx],epoch_dir)
        plot_dict = {
        ...
        plot_3d_density(ground_truth[sample_idx],measurements[sample_idx],range_x,range_y,band_limit,epoch_dir,plot_dict,"CNN UE density")
        #
...
if __name__ == "__main__":
  ...
  wandb.init(project="Diff-HEF",group="R2",entity="korra141",
              tags=["R2", "Uncertainity Estimation", "CNN", "predicting density","predicting delta density","measurement likelihood"],
