...
def main(args):
  ...
  run_name = "Uncertainity Estimation in R2 Local Grid"
  ...
  for epoch in range(num_epochs):
    ...
    for batch_idx, (ground_truth, measurements) in enumerate(train_loader):
      ...
      target_distribution = GaussianDistribution(ground_truth,measurement_noise,band_limit,x_range=range_x,y_range=range_y)
      ...
      target_distribution_local_grid = GaussianDistribution(ground_truth,measurement_noise,band_limit,range_x_diff=range_x_diff_local,range_y_diff=range_y_diff_local)
      ...
      kl_div_1 = kl_divergence(predicted_density, true_density_local_grid)
      ...
      if batch_idx==0 and epoch % 10 == 0:
        ...
        plot_density(ground_truth[sample_idx],measurements[sample_idx],range_x,range_y,log_dir,epoch,plot_dict,"CNN Local UE density")
...
if __name__ == "__main__":
  ...
  parser.add_argument('--architecture', type=int, choices=[0, 1, 2, 3, 4], default=1, help='Choice of architecture (0, 1, 2, 3, 4)')
