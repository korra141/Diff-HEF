...
from src.models.CNN import DensityPredictorMLPCNN, DensityPredictorCNN,init_weights_identity, initialize_weights
...
if __name__ == "__main__":
  ...
  parser.add_argument('--architecture', type=int, choices=[0, 1, 2, 3, 4], default=0, help='Choice of architecture (0, 1, 2, 3, 4)')
