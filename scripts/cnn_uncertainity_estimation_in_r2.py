...
from src.models.CNN import DensityPredictorCNN,init_weights_identity,init_weights_zero
...
if __name__ == "__main__":
  ...
  parser.add_argument('--band_limit', type=str, default="100 100", help='Band limit')
